...
class SolicitudList(ListView):
	#model=Solicitud---> asi estava cuando no ordenaba 
	#hay que escribir queryset para ordenar -descendentemente, +ascendentemente
	queryset=Solicitud.objects.order_by("id")
